      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-green-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Schulung & Förderung</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Wissen weitergeben und Talente fördern – das liegt uns am Herzen
            </p>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { emoji: '📚', title: 'Weiterbildung', description: 'Wir bilden uns stetig weiter, um Ihnen die neuesten Trends und Techniken in der Ballonkunst anbieten zu können.' },
              { emoji: '🌟', title: 'Nachwuchsförderung', description: 'Wir unterstützen junge Talente und geben unser Wissen gerne weiter, damit die Ballonkunst lebendig bleibt.' },
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
