  ...
  return (
    <section className="py-20 bg-gradient-to-r from-pink-400 via-blue-400 to-yellow-400 relative overflow-hidden">
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        ...
        <div
          className="absolute bottom-0 right-10 w-40 h-40 bg-white rounded-full mix-blend-overlay filter blur-2xl animate-pulse"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <Link
            href="/kontakt"
            className="inline-block bg-white text-pink-500 hover:bg-gray-50 font-bold text-lg px-10 py-5 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
          >
            Kontaktieren
          </Link>
        </motion.div>
